...
## INSTALLATION
Install the programme by downloading the HTML and CSS files. 
The Python backend is written directly into the html file, with Pyscript. 
This helps to keep installation simple. 
...
## STORAGE
There is no long-term storage file, but the PyScript function will store the single last calculation you solve with the arithmetic calculator, 
and displays this on your next visit, after you click into the textbox.
